...
namespace MessagePack.Formatters
{
    public sealed class CharacterInfoFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::CharacterInfo>
    {
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::CharacterInfo value, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            writer.Write(value.CurrentMana);
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::Stat>(formatterResolver).Serialize(ref writer, value.Stat, options);
        }
            ...
            for (int i = 0; i < length; i++)
            {
                switch (i)
                {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        ____result.CharacterType = reader.ReadUInt16();
                        break;
                    case 5:
                        ____result.CurrentHealth = reader.ReadSingle();
                        break;
                    case 6:
                        ____result.CurrentMana = reader.ReadSingle();
                        break;
                    case 7:
                        ____result.Stat = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::Stat>(formatterResolver).Deserialize(ref reader, options);
                        break;
                    default:
                        reader.Skip();
                        break;
